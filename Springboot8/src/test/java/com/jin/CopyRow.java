...
public class CopyRow {
    public static void main(String[] args) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        ...
        writeExcel1("E:\\ExcelTest\\报价单4.xlsx");
    }
    ...
    public static void writeExcel1(String finalXlsxPath) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        int n=8;
        System.out.println(setheights.getMergedRows((XSSFRow) sheet.getRow(12)));
       for (int i=0;i<n;i+=2){
           /* if (!template1.isRowEmpty(sheet.getRow(13+i))){
                n++;
                continue;
            }*/

            template1.copyRow(workBook,sheet.getRow(12),sheet.getRow(13),14+i,14+i);
      }
        try {
