...
public class template1 {
       ...
       public static void copyRow(Workbook wb,Row fromRow,Row endRow,int toRow,int i){

           Sheet sheet = wb.getSheetAt(0);
           for (int m=fromRow.getRowNum();m<=endRow.getRowNum();m++){
          // if (fromRow!=null){
             Row  sourceRow = sheet.getRow(m);
               if (sourceRow!=null){
                   int count=0;
                   Row row=sheet.createRow(toRow-fromRow.getRowNum()+m);
    ...
    public static boolean isMergedRegion(Sheet sheet,int row ,int column) {
        ...
        public static void copyCell(Workbook wb, Cell srcCell, Cell distCell) {
            ...
            if (srcCell.getCellComment() != null) {
                ...
                Comment cellComment = drawing.createCellComment(new XSSFClientAnchor(0, 0, 0, 0, 2, 2, 3, 5));
