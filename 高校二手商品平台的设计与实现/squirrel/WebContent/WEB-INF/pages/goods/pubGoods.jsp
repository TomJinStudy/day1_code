                ...
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="changeinfo">
                        ...
                        <select class="in_info" name="catelogId">
                            <option value="1">电子类</option>
                            <option value="2">校园类</option>
                            <option value="3">数码类</option>
                            <option value="4">教学类</option>
                            <option value="5">时尚类</option>
                            <option value="6">运动类</option>
                            <option value="7">科技类</option>
                        </select>
                    </div>
